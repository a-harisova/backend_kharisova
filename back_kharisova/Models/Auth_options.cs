...
{
    public class Auth_options
    {
        public static string Issuer => "KharisovaDilya";
        public static string Audience => "ApiClient";
        public static int LifetimeInYears => 1;
        public static SecurityKey SigningKey => new SymmetricSecurityKey(Encoding.ASCII.GetBytes("KharisovaDilyaAsu"));
